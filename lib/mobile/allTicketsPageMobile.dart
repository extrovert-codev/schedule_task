...
class AllTicketsPageMobile extends StatefulWidget {
  const AllTicketsPageMobile({Key? key}) : super(key: key);

  @override
  _AllTicketsPageMobileState createState() => _AllTicketsPageMobileState();
}

class _AllTicketsPageMobileState extends State<AllTicketsPageMobile> {
  @override
