...
class AddTicketsMobile extends StatefulWidget {
  const AddTicketsMobile({Key? key, required this.empID}) : super(key: key);

  final empID;

  @override
  _AddTicketsMobileState createState() => _AddTicketsMobileState();
}
